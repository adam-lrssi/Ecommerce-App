...
> **Attention :** Ce projet est actuellement en cours de développement. De nouvelles fonctionnalités sont ajoutées et l'existant est susceptible d'être modifié.

Ce dépôt contient le code source d'une application e-commerce full-stack moderne. L'objectif est de construire une solution de boutique en ligne complète, de la navigation utilisateur à l'authentification, jusqu'aux paiements sécurisés et à un panel d'administration.
...
Voici l'ensemble des fonctionnalités prévues pour l'application.
